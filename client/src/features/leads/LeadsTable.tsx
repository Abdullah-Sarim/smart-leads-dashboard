...
export function LeadsTable({ leads, currentUser, onView, onEdit, onDelete }: LeadsTableProps) {
  return (
            ...
            <tr key={lead._id} className="border-b border-gray-100 hover:bg-gray-50">
              ...
              <td className="py-3 px-4">
                <div className="flex items-center justify-end gap-1">
                  <button onClick={() => onView(lead)} className="p-1.5 rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-100" title="View">
